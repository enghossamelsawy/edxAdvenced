...
/**
 * Created by Hossam Elsawy on 7/12/17.
 * Xdigital Group company
 */

public class LoginModelImp1 implements LoginModel {
...
private  OnLoginFinishListener loginFinishListener;
    ...
    public void login(String username, String password, OnLoginFinishListener listener) {
        ...
        this.loginFinishListener= listener;
        //TODO: call login task
